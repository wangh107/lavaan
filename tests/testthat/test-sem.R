...
"
  ...
  expected_params <- data.frame(
    lhs = c(
      rep("ind60", 3), rep("dem60", 4), rep("dem65", 4), # Latent Variables
    ...
    rhs = c(
      paste0("x", 1:3), paste0("y", 1:8), # Latent Variables
      "ind60", "ind60", "dem60", # Regressions
      paste0("y", c(5, 4, 6, 7, 8, 8)), # Covariances
      paste0("x", 1:3), paste0("y", 1:8), "ind60", "dem60", "dem65" # Variances
    ),
    est = c(
      1.000, 2.180, 1.819, 1.000, 1.257, 1.058, 1.265, 1.000, 1.186, 1.280,
    ...
    std.lv = c(
      0.670, 1.460, 1.218, 2.223, 2.794, 2.351, 2.812, 2.103, 2.493,
    ...
    std.all = c(
      0.920, 0.973, 0.872, 0.850, 0.717, 0.722, 0.846, 0.808, 0.746,
